...
const changeImportantWords = () => {
  const importantWords = [
    ...
    'Пожелать хочу терпения и сил ахаха (как и говорил уже)',
    'Если бы я мог подарить тебе возможность видеть мир моими глазами, ты бы увидела, какая ты потрясающая!',
    '"Противоположности притягиваются... вот это бред", — усмехнувшись, подумал я... И притянулся к тебе',
  ];
